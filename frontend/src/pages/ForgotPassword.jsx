  ...
  return (
    <div className="grid min-h-screen place-items-center px-4 py-10">
      <form onSubmit={handleSubmit} className="w-full max-w-md rounded-[2rem] border border-white/70 bg-white/75 p-8 shadow-2xl shadow-slate-900/10 backdrop-blur">
        <p className="text-sm font-bold uppercase tracking-[0.25em] text-emerald-700">Account recovery</p>
        <h1 className="mt-3 text-4xl font-black tracking-[-0.04em] text-slate-950">Forgot password</h1>
        <p className="mt-3 text-sm text-slate-600">Enter your email and we will send a reset link.</p>
        ...
        <p className="mt-5 text-center text-sm text-slate-600">
          Remembered it? <Link to="/login" className="font-bold text-emerald-800">Login</Link>
        </p>
      </form>
    </div>
  );
